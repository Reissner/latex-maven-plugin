...
\begin{longtable}{|ll|}
  ...
  & \texttt{\footnotesize Add file '\$pdfFileCmp' to compare with artifact from '\$texFile'! }  \\
  \multicolumn2{|l|}{
  \begin{minipage}{0.95\linewidth}
  ...
  Then before building the file '\$pdfFileCmp' shall be removed before compilation 
