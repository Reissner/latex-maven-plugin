...
\begin{itemize}
  ...
  to the line containing the \cmd{documentclass} or \cmd{documentstyle} command 
  is changed or
  \item 
...
We could have decided that these files are compiled anyway, 
...
So far, \texttt{scrlttr2} is the only KOMA\index{KOMA} class 
...
The new thing is not the \cmd{RequirePackage}, 
...
\lstinputlisting[linerange={119-143},
