...
\begin{itemize}
  ...
  One approach is the script \texttt{vmdiff} % these scripts must be added to the index 
  ...
  % and even 
  described in Section~\ref{subsec:pythontexW} % TBD: change {subsec:ntlatexVmdiff}
