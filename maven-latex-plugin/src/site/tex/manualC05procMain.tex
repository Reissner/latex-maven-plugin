...
impose their particular standards. 
...
the sub-standards families PDF/A, for archiving, PDF/X for print and PDF/UA for unlimited accessibility are defined. 

This software uses \tool{verapdf} for verification 
and is thus restricted to PDF standards PDF/A and PDF/UA\@. 
Note that these families consist of individual parts, 
partially tied to an according PDF version. 
So, the PDF/A-2 is tied to PDF 1.7. 
It consists of two conformance levels b for basic and a for accessible. 


As described in Section~\ref{****}, 
\cmd{DocumentMetadata} among other things, allows specifying the PDF version and the PDF standard, as e.g. \texttt{a-2b}. 
...
Because of this metadata \tool{verapdf} applied to the PDF file, knows the precise standard(s) with part and level to be verified 
