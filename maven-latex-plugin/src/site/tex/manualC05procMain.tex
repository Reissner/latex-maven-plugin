...
and if the package is loaded with option \ttexttt{depythontex} 
...
as \texttt{(de)pythontex} requires, 
went out of fashion. 
...
uses the python interpreter already installed, a
s a prerequisite of \tool{pythontex}. 
