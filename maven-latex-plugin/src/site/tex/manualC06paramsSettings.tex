...
which are to control metadata as described in Section~\ref{sec:verify} and may be needed to ensure reproducibility 
...
For a general description of the validation feature consult Section~\ref{sec:verify}. 
...
\begin{longtable}{|ll|}
  ...
  \texttt{verifyStdOptions}      & \texttt{-f 0 -{}-format text}  \\
  \multicolumn2{|l|}{
  \begin{minipage}{0.95\linewidth}
