...
e.g.\@ for converter category \tool{fig2dev} converting \gls{fig}-files, \index{fig2dev}
...
\endlastfoot%
\texttt{fig2devCommand}   & \tool{fig2dev}\index{fig2dev}     \\
\multicolumn2{|l|}{
\begin{minipage}{0.95\linewidth}
...
\begin{longtable}{|ll|}
  ...
  \begin{minipage}{0.95\linewidth}
    ...
    \tool{exiftool} or \tool{pdfinfo} \index{exiftool}\index{pdfinfo}
