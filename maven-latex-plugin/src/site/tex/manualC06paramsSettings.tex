...
Note that all but \texttt{docClass} are optional. 
...
\begin{description}
  ...
  \item[chkDiffMagic]
  whether the created file shall be checked against an original 
...
\section{Parameters for \texttt{latexmk} and related}\label{sec:paramLatexmk}
...
\begin{longtable}{|ll|}
  ...
  \begin{minipage}{0.95\linewidth}
    ...
    Instead of the default value \texttt{latexmk} a wrapper is conceivable, 
