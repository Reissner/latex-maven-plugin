...
% documentmetadata refers to PDF; 
% it is here just to ensure that this latex main file is recognized 
...
\begin{document}
Tests magic comment: 
exclude target \texttt{pdf} individually specifying \texttt{chk} and \texttt{dvi}. 
