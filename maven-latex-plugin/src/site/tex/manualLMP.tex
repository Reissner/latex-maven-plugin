...
\newacronym{log}{LOG}{LOGing file: for \LaTeX{} engines and \tool{mpost}}
...
\newacronym{blg}{BLG}{Bibliography LoG file: for \tool{bibtex} and related}
...
\newacronym{ilg}{ILG}{Index LoG file:: for \tool{makeindex} and related; content depends strongly on the tool}
